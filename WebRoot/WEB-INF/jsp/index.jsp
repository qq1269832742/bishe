...
<script type="text/javascript">
    ...
    <body class="easyui-layout">  
        <!-- 正上方panel -->  
        <div data-options="region:'north',border:false" style="height:60px;padding:0px; background: #D4F2F4;font-color:#626262;">
            ...
            <div class="easyui-tabs" id="mainTabs" fit="true" border="false">  
                <div title="欢迎使用" style="padding:20px;">   
                    <div style="margin-top:20px; float:left;min-width:600px;widht: 600px; height: 90%;">  
                        <h1 style="font-weight: lighter;font-size:24px;font-family:'微软雅黑';color:#626262;">欢迎使用借贷管理系统</h1>
                    </div>  
                </div>  
            </div>  
        </div>  
        ...
        <div region="south" style="height:24px;line-height:22px;" align="center">  
            <label style="font-size:11px;">借贷管理系统&nbsp;&nbsp;&nbsp;[&nbsp;1269832742@qq.com&nbsp;]</label>  
        </div>   
    </body>
</html>
